...
const TaskCard = (props) => {
    ...
    const { updateTasksHandler} = appContext
    ...
    return (
        <>
            ...
            <TaskModal open={openTask} onClose={() => setIsOpenTask(false)} id={id} name={name} date={date} status={status} updateHandler={updateTasksHandler}>
            </TaskModal>
        </>
    );
};
