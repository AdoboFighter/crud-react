...
const TaskCard = (props) => {
    ...
    return (
        <>
            ...
            <div className="item mb-3 select-none cursor-pointer bg-gray-200 rounded-md flex flex-1 items-center p-4  transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-lg">
                ...
                <div className="mt-2 flex flex-row-reverse">
                    ...
                    <Link to={{ pathname: `/edit`, state: { task: props.task } }}>
                        <button type="button" className="focus:outline-none border-black  text-blue text-sm py-2.5 px-5 rounded-md bg-white-500 hover:bg-blue-600 hover:shadow-lg flex-row-reverse">
            ...
            <TaskModal open={openTask} onClose={() => setIsOpenTask(false)} id={id} name={name} status={status}>
